...
class admin_area extends connect
{
    ...
    admin_area.id_journey AS "journey_id_fk",
    admin_area.id_position AS "position_id_fk",
    ...
    public function post_admin_area()
    {
        ...
        try {
            ...
            $res->bindValue("journeys_id_fk", $this->id_journey);
    ...
    public function update_admin_area($id)
    {
        /*Prepare es literalmente preparar el query */
    ...
    public function delete_admin_area($id)
    {
        /*Prepare es literalmente preparar el query */
