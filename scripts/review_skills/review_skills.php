...
{
    private $queryPost = 'INSERT INTO review_skills ( id_team_schedule , id_journey, id_tutor, id_location ) VALUES ( :schedule_id_fk, :journey_fk, :tutor_fk,:location_fk)';
    private $queryPut = 'UPDATE review_skills SET id_team_schedule = :schedule_id_fk, id_journey = :journey_fk, id_tutor = :tutor_fk,id_location = :location_fk WHERE  id = :id';
    private $queryCampos = 'SELECT column_name FROM information_schema.columns WHERE table_name = "review_skills" AND table_schema = "campusland"';
    private $queryGetAll = 'SELECT review_skills.id AS "id",
    review_skills.id_team_schedule AS "team_schedule",
    review_skills.id_journey AS "journey",
    review_skills.id_tutor AS "tutor_fk",
    review_skills.id_location AS "location",
    ...
    public function update_review_skills($id)
    {
        /*Prepare es literalmente preparar el query */
    ...
    public function delete_review_skills($id)
    {
        /*Prepare es literalmente preparar el query */
