...
class team_educators extends connect
{
    ...
    private $queryPut = 'UPDATE team_educators SET name_rol = :rol WHERE  id = :id';
    private $queryCampos = 'SELECT column_name FROM information_schema.columns WHERE table_name = "team_educators" AND table_schema = "campusland"';
    private $queryGetAll = 'SELECT  id AS "id", name_rol AS "rol" FROM team_educators';
    private $queryDelete = 'DELETE FROM team_educators WHERE id = :id';
    private $message;

    use getInstance;
    //*Se definen el tipo de dato: static, private, public
    function __construct(public $id = 1, public $name_rol = 1)
    {
        parent::__construct();
    ...
    public function update_team_educators($id)
    {
        /*Prepare es literalmente preparar el query */
    ...
    public function delete_team_educators($id)
    {
        /*Prepare es literalmente preparar el query */
