...
{
    private $queryPost = 'INSERT INTO chapters (id_thematic_units, name_chapter, start_date,end_date, description, duration_days) VALUES (:thematics_fk, :chapter, :date, :end_date,:description, :duration_days)';
    private $queryPut = 'UPDATE chapters SET id_thematic_units = :thematics_fk, name_chapter = :chapter, start_date = :date, end_date = :end_date, description = :description, duration_days = :duration_days WHERE  id = :id';
    private $queryCampos = 'SELECT column_name FROM information_schema.columns WHERE table_name = "chapters" AND table_schema = "campusland"';
    private $queryGetAll = 'SELECT chapters.id AS "id",
    chapters.id_thematic_units AS "thematics_fk",
    chapters.name_chapter AS "chapter",
    chapters.start_date AS "start_date",
    chapters.end_date AS "end_date",
    chapters.description AS "description",
    chapters.duration_days AS "duration_days",
    thematic_units.name_thematics_units AS "name_units_fk"
    FROM chapters
    ...
    public function update_chapters($id)
    {
        /*Prepare es literalmente preparar el query */
