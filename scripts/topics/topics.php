...
class topics extends connect
{
    ...
    private $queryCampos = 'SELECT column_name FROM information_schema.columns WHERE table_name = "topics" AND table_schema = "campusland"';
    private $queryGetAll = 'SELECT topics.id AS "id",
    topics.id_module AS "module_fk",
    topics.name_topic AS "topic",
    topics.start_date AS "start_date",
    topics.end_date AS "end_date",
    topics.description AS "description",
    topics.duration_days AS "days",
    modules.name_module AS "name_module_fk"
    FROM topics
